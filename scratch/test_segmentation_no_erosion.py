...
# 确保配置中 spatial_res 为 30.0，且关闭破坏性的开运算
config["spatial"]["resolution_meters"] = 30.0
config["segmentation"]["apply_boundary_erosion"] = False
config["segmentation"]["min_parcel_area_m2"] = 3600.0 # 4 个 30m 像元 (约 5.4 亩)
config["segmentation"]["max_export_parcels"] = 5000
